...
tweet_id VARCHAR(16) NOT NULL, # Changed to VARCHAR to load in all data
...
# The CSV file can be found at this link https://www.kaggle.com/manchunhui/us-election-2020-tweets?select=hashtag_joebiden.csv
...
# The CSV file can be found at this link https://www.kaggle.com/manchunhui/us-election-2020-tweets?select=hashtag_donaldtrump.csv
...
# The CSV file can be found at this link https://www.kaggle.com/unanimad/us-election-2020?select=president_county_candidate.csv
...
INSERT INTO tweet_megatable
SELECT created_at, tweet_id, tweet, likes, retweet_count, source, user_id, user_name, user_screen_name, user_description, user_join_date, user_followers_count, user_location, lat, lon, city, country, continent, state, state_code, collected_at, (likes + retweet_count) AS total_popularity, "Donald Trump" AS tweet_candidate, 
CASE
    WHEN retweet_count = 0 THEN likes/1 
    ELSE likes/retweet_count
END AS tweet_ratio
