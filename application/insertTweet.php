...
if (isset($_POST['f_submit'])) {
    ...
    $query = "INSERT INTO tweet_info (tweet_id, user_id, created_at, collected_at, source, tweet, likes, retweet_count, total_popularity, candidate, tweet_ratio)"
             . "VALUES (:tweet_id, :user_id, :created_at, :collected_at, :source, :tweet, :likes, :retweet_count, :total_popularity, :candidate, :tweet_ratio)";
...
<h1> Insert Tweet </h1>
    ...
    <form method="post">
	<label for="id_tweet_id">Tweet Id</label>
    	<input type="text" name="f_tweet_id" id="id_tweet_id">
